    ...
    <div class="flex justify-between items-center flex-wrap">
      ...
      <el-row :gutter="20">
            ...
            <el-main>
              <el-scrollbar style="width:2.8rem" height="3rem">
                <el-table :data="ForceFirmsList" >
                  ...
                  <el-table-column prop="salary" align="center" label="" style="font-size:0.08rem" />
                </el-table>
              </el-scrollbar>
            </el-main>
          </el-container>
        ...
        <div style="width:5.1rem;height:3.5rem;box-shadow: 10px 10px 15px #000101ce">
          ...
          <br/>
          <div style="margin-left:10%;font-size:0.1rem;display:inline-block;"> &nbsp;</div>
          <div style="font-family:math;font-style:italic;font-size:0.3rem;display:inline-block;"></div>
          &nbsp;&nbsp;&nbsp;
          <div style="margin-left:10%;font-size:0.1rem;display:inline-block;"> &nbsp;</div>
          <div style="font-family:math;font-style:italic;font-size:0.3rem;display:inline-block;"></div>
...
export default {
  ...
  methods: {
    ...
    queryForceFirms() {
      ...
      let cypher = `match p=(n:\`产业\`{name:"金属制品、机械和设备修理业"})-[*1..3]->() return p`; 
    ...
    getTotalIndustryData(){
      ...
      let nodes = new Set()
      const session = this.$neo4j.getSession();
      let cypher = `match p=(n:\`产业\`{name:"金属制品、机械和设备修理业"})-[*1..3]->(m:\`单位\`) return p`; 
      session.run(cypher).then(res => {
        let records = res.records;
